...
In this section, we have presented the abstract syntax and the semantics of \bcool. Also, we have presented \moccml for the definition of libraries. In the next section, we present the current implementation of \bcool as a set of Eclipse plugins into th GEMOC studio. 
