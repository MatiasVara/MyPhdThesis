...
%To specify coordination patterns, a language integrator should rely on a dedicated language. Such specification defined at language level should enable a system designer to synthesize a coordination model when applied between particular models. The generated model of coordination should be expressed in a formal language to enable reasoning on the global system. 
