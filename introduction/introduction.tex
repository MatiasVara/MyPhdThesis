...
\item \todo{Implementation into the gemoc studio}
...
\item To validate \bcool, we present in Chapter~\ref{ch:examples} the coordination of the heterogeneous model of a surveillance video system.  
