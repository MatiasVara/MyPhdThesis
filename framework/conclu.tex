\section{Conclusion}
In this chapter, we have determined three building blocks to capture the specification of coordination patterns: a language behavioral interface, a correspondence rule and a coordination rule. Table~\ref{table:framework} summarizes the studied approaches.     
 
\begin{table}[]
	\centering
	\caption{Sumarize of the framed approaches}
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\begin{tabular}[c]{@{}c@{}}Ptolemy \\ ModHel'X\end{tabular} & \begin{tabular}[c]{@{}c@{}}generic, \\ made of methods in Java\end{tabular} & \begin{tabular}[c]{@{}c@{}}explicit, \\ composite actors\end{tabular}    & Java                                                         \\ \hline
		MASCOT                                                      & \begin{tabular}[c]{@{}c@{}}encoded by using \\ wrappers in C\end{tabular}   & \begin{tabular}[c]{@{}c@{}}implicit, \\ naming convention\end{tabular} & C                                                            \\ \hline
		Di Natale                                                   & Encoded in C++                                                              & \begin{tabular}[c]{@{}c@{}}explicit, \\ connectors\end{tabular}        & C++                                                          \\ \hline
	\end{tabular}
\end{table}
