...
In this section, we have presented some requirements to improve the way that approaches defines correspondence rules at language level and correspondences between models. % We proposed four requirements for a flexible implementation of correspondences and correspondences rules. They should: 
%\begin{enumerate}
